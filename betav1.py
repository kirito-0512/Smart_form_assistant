'''
    This is python script written to provide an interface for filling E-forms
    -DH
'''
from tkinter import *
...
w.place(x=0,y=50)
title = Label(window, text = "Enter form Details and select the Input Format",font =("Algerian", 15),bg='Cyan')
...
def on_change(e):
    print(e.widget.get())
    form_name.append(e.widget.get())
fentry.pack()
fentry.place(x= 180, y=115)
fentry.bind("<Return>", on_change)
...
#option.add_argument("disable-gpu")
    ...
    form_names = ''.join(form_name)
    browser.get(form_names)
...
def headnames():
   ...
   # browser.get("https://docs.google.com/forms/d/e/1FAIpQLSfe4EtquGpr_yKtBF9G5OhkH6wTkFhY15JtYGCDDXUadePOZA/viewform?vc=0&c=0&w=1&flr=0")
    ...
    title.place(x= 300,y=300)
                                                
        
#b6 = tk.Button(window,text = "Show Image",command = insertpic,bg = "pink")
b3 = tk.Button(window,height = 5,width = 30,text  = "Show headings", command = headnames,bg = "yellow" )
b4 = tk.Button(window,height = 5,width = 30,text  = "Photo", command = ocr,bg = "red" )
b5 = tk.Button(window,height = 5,width = 30,text  = "Voice", command = voice_recognizer,bg = "green" )
b3.place(x = 300, y = 170)
b4.place(x = 600, y = 170)
b5.place(x = 900, y = 170)
